...
impl LifecycleExpirationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<LifecycleExpiration, XmlParseError> {
...
impl PutBucketNotificationRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PutBucketNotificationRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct ErrorsParser;
impl ErrorsParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Errors, XmlParseError> {
		let mut obj = Vec::new();
...
impl PutBucketVersioningRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PutBucketVersioningRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CopySourceVersionIdParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CopySourceVersionId, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl TopicConfigurationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<TopicConfiguration, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl DestinationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Destination, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl IfNoneMatchParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<IfNoneMatch, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl NoSuchBucketParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<NoSuchBucket, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ObjectVersionStorageClassParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ObjectVersionStorageClass, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl MultipartUploadIdParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<MultipartUploadId, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl WebsiteRedirectLocationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<WebsiteRedirectLocation, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl BucketVersioningStatusParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<BucketVersioningStatus, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl PutBucketReplicationRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PutBucketReplicationRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GetObjectTorrentRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetObjectTorrentRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GetBucketReplicationRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketReplicationRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl NoncurrentVersionTransitionParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<NoncurrentVersionTransition, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GetBucketTaggingOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketTaggingOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct BodyParser;
impl BodyParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Body, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl PutObjectOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PutObjectOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl PutObjectAclOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PutObjectAclOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ReplicationConfigurationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ReplicationConfiguration, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl RequestPayerParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<RequestPayer, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl GetBucketWebsiteRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketWebsiteRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct RulesParser;
impl RulesParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Rules, XmlParseError> {
		let mut obj = Vec::new();
...
impl CompleteMultipartUploadRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CompleteMultipartUploadRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CreateBucketOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CreateBucketOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl DeleteMarkerEntryParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeleteMarkerEntry, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl TargetBucketParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<TargetBucket, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl MFADeleteStatusParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<MFADeleteStatus, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl MaxKeysParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<MaxKeys, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct PartParser;
impl PartParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Part, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl TargetGrantsParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<TargetGrants, XmlParseError> {
		let mut obj = Vec::new();
...
impl ListMultipartUploadsRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ListMultipartUploadsRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GetBucketPolicyRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketPolicyRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CloudFunctionParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CloudFunction, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl DeleteBucketWebsiteRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeleteBucketWebsiteRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl VersioningConfigurationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<VersioningConfiguration, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GetBucketCorsRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketCorsRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl IndexDocumentParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<IndexDocument, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl TopicConfigurationListParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<TopicConfigurationList, XmlParseError> {
		let mut obj = Vec::new();
...
impl ReplaceKeyPrefixWithParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ReplaceKeyPrefixWith, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl CreateMultipartUploadRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CreateMultipartUploadRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl PutBucketCorsRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PutBucketCorsRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CopySourceSSECustomerAlgorithmParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CopySourceSSECustomerAlgorithm, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl GetBucketAclOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketAclOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct DaysParser;
impl DaysParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Days, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = i32::from_str(try!(characters(stack)).as_ref()).unwrap();
		try!(end_element(tag_name, stack));
		Ok(obj)
...
struct ValueParser;
impl ValueParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Value, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl DeletedObjectsParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeletedObjects, XmlParseError> {
		let mut obj = Vec::new();
...
impl DeleteBucketLifecycleRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeleteBucketLifecycleRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl KeyMarkerParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<KeyMarker, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl DeleteMarkersParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeleteMarkers, XmlParseError> {
		let mut obj = Vec::new();
...
impl AbortMultipartUploadOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<AbortMultipartUploadOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl PutBucketPolicyRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PutBucketPolicyRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ResponseContentDispositionParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ResponseContentDisposition, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl GrantFullControlParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GrantFullControl, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl GetObjectAclRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetObjectAclRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl SSECustomerAlgorithmParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<SSECustomerAlgorithm, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl CommonPrefixListParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CommonPrefixList, XmlParseError> {
		let mut obj = Vec::new();
...
struct SuffixParser;
impl SuffixParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Suffix, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl AllowedMethodParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<AllowedMethod, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl QueueConfigurationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<QueueConfiguration, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl BucketCannedACLParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<BucketCannedACL, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl SSECustomerKeyParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<SSECustomerKey, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ObjectVersionIdParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ObjectVersionId, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl HeadBucketRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<HeadBucketRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl AbortMultipartUploadRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<AbortMultipartUploadRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct SizeParser;
impl SizeParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Size, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = i32::from_str(try!(characters(stack)).as_ref()).unwrap();
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl UploadPartCopyOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<UploadPartCopyOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl RedirectParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Redirect, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CopySourceIfNoneMatchParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CopySourceIfNoneMatch, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl DeleteBucketCorsRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeleteBucketCorsRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl BucketAlreadyExistsParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<BucketAlreadyExists, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl BucketLocationConstraintParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<BucketLocationConstraint, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl GetBucketNotificationConfigurationRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketNotificationConfigurationRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl NextKeyMarkerParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<NextKeyMarker, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl AllowedMethodsParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<AllowedMethods, XmlParseError> {
		let mut obj = Vec::new();
...
impl DeleteObjectOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeleteObjectOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl VersionIdMarkerParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<VersionIdMarker, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl StorageClassParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<StorageClass, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl CreateBucketConfigurationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CreateBucketConfiguration, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl BucketLogsPermissionParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<BucketLogsPermission, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl HeadObjectRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<HeadObjectRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl DisplayNameParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DisplayName, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl GrantReadACPParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GrantReadACP, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
struct GrantParser;
impl GrantParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Grant, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl TopicConfigurationDeprecatedParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<TopicConfigurationDeprecated, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CopySourceIfModifiedSinceParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CopySourceIfModifiedSince, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl InitiatorParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Initiator, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl HttpRedirectCodeParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<HttpRedirectCode, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ListObjectVersionsRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ListObjectVersionsRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl DeleteBucketRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeleteBucketRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl TargetPrefixParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<TargetPrefix, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl DeleteBucketPolicyRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeleteBucketPolicyRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CloudFunctionInvocationRoleParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CloudFunctionInvocationRole, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl HeadObjectOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<HeadObjectOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl DeleteBucketReplicationRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeleteBucketReplicationRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl PartNumberParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PartNumber, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = i32::from_str(try!(characters(stack)).as_ref()).unwrap();
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ExposeHeadersParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ExposeHeaders, XmlParseError> {
		let mut obj = Vec::new();
...
impl GetBucketLoggingOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketLoggingOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ListObjectsRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ListObjectsRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GetBucketReplicationOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketReplicationOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ListMultipartUploadsOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ListMultipartUploadsOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl IfUnmodifiedSinceParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<IfUnmodifiedSince, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl PermissionParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Permission, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl RequestPaymentConfigurationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<RequestPaymentConfiguration, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct GrantsParser;
impl GrantsParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Grants, XmlParseError> {
		let mut obj = Vec::new();
		while try!(peek_at_name(stack)) == "Grant" {
...
impl ObjectStorageClassParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ObjectStorageClass, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl EventListParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<EventList, XmlParseError> {
		let mut obj = Vec::new();
...
impl EmailAddressParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<EmailAddress, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl CreateMultipartUploadOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CreateMultipartUploadOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl PutBucketWebsiteRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PutBucketWebsiteRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl IsTruncatedParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<IsTruncated, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CreateBucketRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CreateBucketRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl BucketNameParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<BucketName, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl TargetGrantParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<TargetGrant, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl MetadataDirectiveParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<MetadataDirective, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl PutBucketRequestPaymentRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PutBucketRequestPaymentRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl PutObjectAclRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PutObjectAclRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CloudFunctionConfigurationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CloudFunctionConfiguration, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl LambdaFunctionArnParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<LambdaFunctionArn, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
struct QuietParser;
impl QuietParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Quiet, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = bool::from_str(try!(characters(stack)).as_ref()).unwrap();
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl AccessControlPolicyParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<AccessControlPolicy, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct RangeParser;
impl RangeParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Range, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl GrantReadParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GrantRead, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl SSECustomerKeyMD5Parser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<SSECustomerKeyMD5, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ObjectIdentifierListParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ObjectIdentifierList, XmlParseError> {
		let mut obj = Vec::new();
...
impl RestoreParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Restore, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl NextVersionIdMarkerParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<NextVersionIdMarker, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
struct DeleteParser;
impl DeleteParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Delete, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ResponseContentLanguageParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ResponseContentLanguage, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ListObjectsOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ListObjectsOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GrantWriteACPParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GrantWriteACP, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl CORSRulesParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CORSRules, XmlParseError> {
		let mut obj = Vec::new();
...
impl ContentLanguageParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ContentLanguage, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl DeleteObjectRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeleteObjectRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CompletedPartListParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CompletedPartList, XmlParseError> {
		let mut obj = Vec::new();
...
impl DeletedObjectParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeletedObject, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CORSRuleParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CORSRule, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl LoggingEnabledParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<LoggingEnabled, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl KeyPrefixEqualsParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<KeyPrefixEquals, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl RedirectAllRequestsToParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<RedirectAllRequestsTo, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct OwnerParser;
impl OwnerParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Owner, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CopyObjectResultParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CopyObjectResult, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ObjectListParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ObjectList, XmlParseError> {
		let mut obj = Vec::new();
...
impl GetBucketLifecycleOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketLifecycleOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct EventParser;
impl EventParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Event, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ReplicationRulesParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ReplicationRules, XmlParseError> {
		let mut obj = Vec::new();
...
struct ObjectParser;
impl ObjectParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Object, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl NextMarkerParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<NextMarker, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ContentEncodingParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ContentEncoding, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl WebsiteConfigurationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<WebsiteConfiguration, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl MFADeleteParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<MFADelete, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl CopySourceSSECustomerKeyParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CopySourceSSECustomerKey, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ResponseContentTypeParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ResponseContentType, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl CompleteMultipartUploadOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CompleteMultipartUploadOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ExposeHeaderParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ExposeHeader, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl CopyPartResultParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CopyPartResult, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GetBucketAclRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketAclRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl HostNameParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<HostName, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl NextUploadIdMarkerParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<NextUploadIdMarker, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl CopyObjectOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CopyObjectOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl AcceptRangesParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<AcceptRanges, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ObjectAlreadyInActiveTierErrorParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ObjectAlreadyInActiveTierError, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CompletedMultipartUploadParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CompletedMultipartUpload, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl InitiatedParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Initiated, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl PutBucketAclRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PutBucketAclRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl UploadPartOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<UploadPartOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CopySourceParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CopySource, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl QueueConfigurationListParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<QueueConfigurationList, XmlParseError> {
		let mut obj = Vec::new();
...
impl ObjectNotInActiveTierErrorParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ObjectNotInActiveTierError, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl TransitionStorageClassParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<TransitionStorageClass, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl DeleteMarkerParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeleteMarker, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = bool::from_str(try!(characters(stack)).as_ref()).unwrap();
		try!(end_element(tag_name, stack));
		Ok(obj)
...
struct RuleParser;
impl RuleParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Rule, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl RoutingRulesParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<RoutingRules, XmlParseError> {
		let mut obj = Vec::new();
...
impl ReplicationRuleParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ReplicationRule, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct DateParser;
impl DateParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Date, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl CacheControlParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CacheControl, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl AllowedOriginParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<AllowedOrigin, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl IfModifiedSinceParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<IfModifiedSince, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ConditionParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Condition, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl DeleteObjectsOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeleteObjectsOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ErrorDocumentParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ErrorDocument, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct PayerParser;
impl PayerParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Payer, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl PutBucketLifecycleRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PutBucketLifecycleRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GetObjectTorrentOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetObjectTorrentOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ContentLengthParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ContentLength, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = i32::from_str(try!(characters(stack)).as_ref()).unwrap();
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl TransitionParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Transition, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl QueueConfigurationDeprecatedParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<QueueConfigurationDeprecated, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GetObjectOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetObjectOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GetBucketLifecycleRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketLifecycleRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CopySourceSSECustomerKeyMD5Parser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CopySourceSSECustomerKeyMD5, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl BucketLoggingStatusParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<BucketLoggingStatus, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl IsLatestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<IsLatest, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = bool::from_str(try!(characters(stack)).as_ref()).unwrap();
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl MaxUploadsParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<MaxUploads, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = i32::from_str(try!(characters(stack)).as_ref()).unwrap();
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl RoutingRuleParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<RoutingRule, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl MissingMetaParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<MissingMeta, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = i32::from_str(try!(characters(stack)).as_ref()).unwrap();
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl SSEKMSKeyIdParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<SSEKMSKeyId, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl AllowedOriginsParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<AllowedOrigins, XmlParseError> {
		let mut obj = Vec::new();
...
impl NoSuchUploadParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<NoSuchUpload, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl PutObjectRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PutObjectRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct CodeParser;
impl CodeParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Code, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ReplicationStatusParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ReplicationStatus, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl AllowedHeadersParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<AllowedHeaders, XmlParseError> {
		let mut obj = Vec::new();
...
impl TaggingParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Tagging, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ContentMD5Parser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ContentMD5, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ObjectVersionParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ObjectVersion, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ListObjectVersionsOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ListObjectVersionsOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl PutBucketNotificationConfigurationRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PutBucketNotificationConfigurationRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct PrefixParser;
impl PrefixParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Prefix, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
struct PartsParser;
impl PartsParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Parts, XmlParseError> {
		let mut obj = Vec::new();
...
impl CopyObjectRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CopyObjectRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl DeleteObjectsRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeleteObjectsRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ListPartsOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ListPartsOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct MarkerParser;
impl MarkerParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Marker, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ObjectCannedACLParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ObjectCannedACL, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl RestoreRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<RestoreRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CompletedPartParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CompletedPart, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl QueueArnParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<QueueArn, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl LocationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Location, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl HttpErrorCodeReturnedEqualsParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<HttpErrorCodeReturnedEquals, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl NotificationConfigurationDeprecatedParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<NotificationConfigurationDeprecated, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl UploadPartCopyRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<UploadPartCopyRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CORSConfigurationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CORSConfiguration, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl LastModifiedParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<LastModified, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ContentRangeParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ContentRange, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl GranteeParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Grantee, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ExpirationStatusParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ExpirationStatus, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl CopySourceIfUnmodifiedSinceParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CopySourceIfUnmodifiedSince, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl GetBucketVersioningRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketVersioningRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl MultipartUploadParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<MultipartUpload, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GrantWriteParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GrantWrite, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
struct TagSetParser;
impl TagSetParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<TagSet, XmlParseError> {
		let mut obj = Vec::new();
...
impl LambdaFunctionConfigurationListParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<LambdaFunctionConfigurationList, XmlParseError> {
		let mut obj = Vec::new();
...
impl ServerSideEncryptionParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ServerSideEncryption, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl GetBucketVersioningOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketVersioningOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl NoncurrentVersionExpirationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<NoncurrentVersionExpiration, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GetBucketRequestPaymentOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketRequestPaymentOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GetObjectRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetObjectRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ContentDispositionParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ContentDisposition, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl MetadataKeyParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<MetadataKey, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ResponseContentEncodingParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ResponseContentEncoding, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl GetBucketLoggingRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketLoggingRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl UploadIdMarkerParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<UploadIdMarker, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
struct TypeParser;
impl TypeParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Type, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl BucketsParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Buckets, XmlParseError> {
		let mut obj = Vec::new();
...
impl ExpiresParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Expires, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl RestoreObjectOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<RestoreObjectOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl RestoreObjectRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<RestoreObjectRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GetBucketLocationOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketLocationOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GetObjectAclOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetObjectAclOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ReplaceKeyWithParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ReplaceKeyWith, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ObjectKeyParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ObjectKey, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl GetBucketTaggingRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketTaggingRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GetBucketPolicyOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketPolicyOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl MaxAgeSecondsParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<MaxAgeSeconds, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = i32::from_str(try!(characters(stack)).as_ref()).unwrap();
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl CopySourceRangeParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CopySourceRange, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl PutBucketTaggingRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PutBucketTaggingRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl GetBucketRequestPaymentRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketRequestPaymentRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CommonPrefixParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CommonPrefix, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl NoSuchKeyParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<NoSuchKey, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl UploadPartRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<UploadPartRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ObjectVersionListParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ObjectVersionList, XmlParseError> {
		let mut obj = Vec::new();
...
struct MFAParser;
impl MFAParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<MFA, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl MultipartUploadListParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<MultipartUploadList, XmlParseError> {
		let mut obj = Vec::new();
...
impl AllowedHeaderParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<AllowedHeader, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
struct BucketParser;
impl BucketParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Bucket, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct URIParser;
impl URIParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<URI, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl RequestChargedParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<RequestCharged, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl PutBucketLoggingRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PutBucketLoggingRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl DelimiterParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Delimiter, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl MetadataValueParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<MetadataValue, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl LifecycleConfigurationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<LifecycleConfiguration, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ExpirationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<Expiration, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl IfMatchParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<IfMatch, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ResponseExpiresParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ResponseExpires, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl DeleteBucketTaggingRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeleteBucketTaggingRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl LambdaFunctionConfigurationParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<LambdaFunctionConfiguration, XmlParseError> {
		try!(start_element(tag_name, stack));
...
struct IDParser;
impl IDParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ID, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl PartNumberMarkerParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<PartNumberMarker, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = i32::from_str(try!(characters(stack)).as_ref()).unwrap();
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl DeleteMarkerVersionIdParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<DeleteMarkerVersionId, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl GetBucketWebsiteOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketWebsiteOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CopySourceIfMatchParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CopySourceIfMatch, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ReplicationRuleStatusParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ReplicationRuleStatus, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ContentTypeParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ContentType, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl GetBucketLocationRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketLocationRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl NextPartNumberMarkerParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<NextPartNumberMarker, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = i32::from_str(try!(characters(stack)).as_ref()).unwrap();
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ListPartsRequestParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ListPartsRequest, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl ResponseCacheControlParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ResponseCacheControl, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
struct ETagParser;
impl ETagParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ETag, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl ObjectIdentifierParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<ObjectIdentifier, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl NotificationIdParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<NotificationId, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl GetBucketCorsOutputParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<GetBucketCorsOutput, XmlParseError> {
		try!(start_element(tag_name, stack));
...
impl CreationDateParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<CreationDate, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = try!(characters(stack));
		try!(end_element(tag_name, stack));
		Ok(obj)
...
impl MaxPartsParser {
	fn parse_xml<'a>(tag_name: &str, stack: &mut XmlStack) -> Result<MaxParts, XmlParseError> {
		try!(start_element(tag_name, stack));
		let obj = i32::from_str(try!(characters(stack)).as_ref()).unwrap();
		try!(end_element(tag_name, stack));
		Ok(obj)
